...
import com.example.demo.domain.common.AggregateRoot;
import com.example.demo.domain.order.events.OrderCancelled;
import com.example.demo.domain.order.events.OrderConfirmed;
import com.example.demo.domain.order.events.OrderCreated;
import com.example.demo.domain.order.events.OrderDelivered;
import com.example.demo.domain.order.events.OrderShipped;
import com.example.demo.domain.shared.AuditInfo;
